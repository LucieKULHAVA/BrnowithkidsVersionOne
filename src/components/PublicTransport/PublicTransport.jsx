    ...
    <>
      <div className="main__desc">
        ...
        <p>
          ...
          routines. And travelling with children is no different. And, like most
          things child-related, you’ll struggle to remember what travelling was
        ...
        <h4>First Aid Kit</h4>
        <p>
          Children are germ magnets at the best of times, so the chances they’ll
          get sick or injured on a walk aren’t exactly low. A well-stocked
          family first aid kit is a must for your suitcase.
        </p>
        <p>What to include in a first aid kit?</p>
        <p>
          Paralen and Nurofen come in sachets which are handy for taking out and
          about, while plasters,desinfection (Jodisol), scisors, a thermometer,
          saline nasal drops, and Sudokrem should get you through minor health
          mishaps.
        </p>
      </div>
    </>
