...
<p>Language:</p>
   ...
   <input onChange={handleChangeInput} type="checkbox" name="language1" id="language1" value="russian" />
   <label htmlFor="language1"> Russian</label><br></br>
   <input onChange={handleChangeInput} type="checkbox" name="language2" id="language2" value="english" />
   <label htmlFor="language2"> English</label><br></br>
   <input onChange={handleChangeInput} type="checkbox" name="language3" id="language3" value="arabic" />
   <label htmlFor="language3"> Arabic</label><br></br>
   <hr />
   <p>Specialisation:</p>
   <input type="checkbox" name="specialisation1" id="specialisation1" value="pediatric" />
   <label htmlFor="specialisation1"> Pediatric</label><br></br>
   <input type="checkbox" name="specialisation2" id="specialisation2" value="dentist" />
   <label htmlFor="specialisation2"> Dentist</label><br></br>
   <input type="checkbox" name="specialisation3" id="specialisation3" value="neurologist" />
   <label htmlFor="specialisation3"> Neurologist</label><br></br>
